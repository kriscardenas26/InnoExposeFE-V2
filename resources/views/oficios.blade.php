            ...
            <div class="row g-5">
                <div class="col-lg-6">
                    <div class="row g-3">
                        <div class="col-6 text-end">
                            <img class="img-fluid bg-white w-100 mb-3 wow fadeIn" data-wow-delay="0.1s" src="img/OficioVista.jpg" alt="">
                            <img class="img-fluid bg-white w-50 wow fadeIn" data-wow-delay="0.2s" src="img/OficioVista3.jpg" alt="">
                        </div>
                        <div class="col-6">
                            <img class="img-fluid bg-white w-50 mb-3 wow fadeIn" data-wow-delay="0.3s" src="img/OficioVista4.jpg" alt="">
                            <img class="img-fluid bg-white w-100 wow fadeIn" data-wow-delay="0.4s" src="img/OficioVista2.jpg" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <div class="section-title">
                        ...
                        <h1 class="display-6">Oficios Favoritos</h1>
                    </div>
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-sm-8">
                            <h5>Amplia gama de oficios</h5>
                            <p class="mb-0">Descubre cómo estos profesionales pueden ayudarte a lograr tus metas y satisfacer tus necesidades con experiencia y dedicación.</p>
                        </div>
                    </div>
                    <div class="border-top mb-4"></div>
                    <div class="row g-3">
                        <div class="col-sm-8">
                            <h5>Conéctate con InnoExpose</h5>
                            <p class="mb-0">En nuestro portal, conectamos a personas con una amplia gama de profesionales y oficios dedicados a servir tus necesidades. Te proporcionamos acceso a una red de personas comprometidas en brindarte los servicios que requieres. </p>
                        </div>
                    </div>
                </div>
            </div>
